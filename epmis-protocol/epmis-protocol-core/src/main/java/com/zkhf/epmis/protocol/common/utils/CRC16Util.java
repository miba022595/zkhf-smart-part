...
public class CRC16Util {
	public static String calcCrc16(String text) {
		...
		String str = ("000" + Integer.toHexString(crc & 0xffff)).toUpperCase();
    ...
    public static void putCrc16(byte[] data) {
        ...
        data[data.length - 3] = (byte) (u16CRC & 0xff);
        data[data.length - 2] = (byte) ((u16CRC >> 8) & 0xff);
    }
}